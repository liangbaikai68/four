		...
		<div class="row">
			...
			<div class="ibox-content">
				<form class="form-horizontal m-t" id="signupForm"
					action="${pageContext.request.contextPath }/web/repairman/regist"
					method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input id="nickName" name="nickName" class="form-control"
								...
								class="valid" value="${repairman.nickName }">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input id="password" name="password" class="form-control"
								type="password" value="${repairman.password }">
						</div>
					</div>
					<div class="form-group">
